...
export default function MockApiTestPage() {
  ...
  const testMockApi = async () => {
    ...
    try {
      // Call our mock API
      const apiUrl = `/api/punting-form-mock?endpoint=${endpoint}`;
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mt-8 p-4 border rounded">
        ...
        <p className="mb-2">
          This page tests the mock API that provides static data for development and testing.
        </p>
        <p className="mb-2">
          The mock API returns realistic-looking data for all endpoints without making any external API calls.
        </p>
        <p className="mb-2">
          This allows you to continue development and testing while we work on resolving the issues with the real API.
        </p>
      </div>
    </div>
  );
